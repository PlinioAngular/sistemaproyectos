    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item dmenu">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar"  id="despliega">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo base_url()?>gerencia">Gerencia</a>
            ...
            <a class="collapse-item" href="<?php echo base_url()?>persona">Persona</a>
            <a class="collapse-item" href="<?php echo base_url()?>clasificacion">Clasificación</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseRendicion" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Mantenimientos</h6>
            <a class="collapse-item" href="<?php echo base_url()?>rendicion">Egresos Por rendir</a>
            <a class="collapse-item" href="<?php echo base_url()?>rendicion/egresos_rendidos">Egresos Rendidos</a>
            <a class="collapse-item" href="<?php echo base_url()?>rendicion/web">Rendiciones Web</a>
          </div>
        </div>
      </li>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow mx-1">
              <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <!-- Counter - Alerts -->
                <span class="badge badge-danger badge-counter"><?php if($notificaciones!=null){echo "Si";} ?></span>
              </a>
              <!-- Dropdown - Alerts -->
