				...
				<form id="add_clasificacion" name="add_clasificacion" accept-charset="utf-8" enctype="multipart/form-data" method="post">
					...
					<div class="row">
						...
						<div class="form-group">
								<label for="">Nombre Clasificacion</label><input autocomplete="off" class="form-control form-control-sm" placeholder="Nombre:" type="text" name="clasificacion" id="clasificacion">
							</div>
						</div>					
					</div>													
