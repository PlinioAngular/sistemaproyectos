				...
				<form id="edit_sub_area" name="edit_sub_area" accept-charset="utf-8" enctype="multipart/form-data" method="post">
					...
					<div class="row">
						...
						<div class="form-group">
								<label for="">Nombre de SubArea</label><input autocomplete="off" value="<?php echo $sub_area->sub_area; ?>" class="form-control form-control-sm" placeholder="sub_area" type="text" name="sub_area" id="sub_area">
							</div>
						</div>					
					</div>													
...
$(document).ready(function() {
		$("form[name='edit_sub_area']").submit(function(e) {
			var formData = new FormData($(this)[0]);
			$.ajax({
				
				url: "<?php echo base_url('sub_area/sub_area_edit'); ?>",
				type: "POST",
				data: formData,
				async: true,
				beforeSend: function(){
				...
				var status=str[0];
					...
					if(status=="si")
					{
						...
						setTimeout(function () {
						window.location.href="<?php echo base_url('sub_area' ); ?>/";
