			...
			<div class="element-wrapper">
				...
				<form  id="add_caja" name="add_caja" accept-charset="utf-8" enctype="multipart/form-data" method="post">
                    ...
                    <div class="row">
                        <div class="col-sm-3">
							<div class="form-group">
								<label for="">N° de Detracción</label>
								<input class="form-control" placeholder="">
							</div>		
						</div>	
                        <div class="col-sm-3">
						    <div class="form-group">
								<label for="">Fecha de Detracción</label><input autocomplete="off" class="form-control" type="date" name="fecha_nacimiento" id="fecha_nacimiento">
							</div>
						</div>
                        <div class="col-sm-3">
							<div class="form-group">
								<label for="">Cod. Detracción</label>
								<input class="form-control" placeholder="">
							</div>		
						</div>
                        <div class="col-sm-3">
							<div class="form-group">
								<label for="">Monto Detracción</label>
								<input class="form-control" placeholder="">
							</div>		
						</div>
                    </div>
