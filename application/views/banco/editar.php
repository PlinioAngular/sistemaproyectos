			...
			<div class="element-wrapper">				
				...
				<form id="edit_banco" name="edit_banco" accept-charset="utf-8" enctype="multipart/form-data" method="post">
					...
					<div class="row">
						<div class="col-sm-6">
						<div class="form-group">
								<label for="">Cuenta soles</label><input value="<?php echo $banco->cuenta_soles; ?>" autocomplete="off" class="form-control" placeholder="Num. Cuenta en soles" type="text" name="cuenta_soles" id="cuenta_soles">
							</div>
						</div>
						<div class="col-sm-6">
						<div class="form-group">
								<label for="">Cuenta Dólares</label><input value="<?php echo $banco->cuenta_dolares; ?>" autocomplete="off" class="form-control" placeholder="Num. Cuenta en dólares" type="text" name="cuenta_dolares" id="cuenta_dolares">
							</div>
						</div>											
					</div>		
					<div class="row">
						<div class="col-sm-5">
						<div class="form-group">
								<label for="">Monto soles</label><input value="<?php echo $banco->monto_soles; ?>" autocomplete="off" class="form-control" placeholder="Total Soles" type="text" name="monto_soles" id="monto_soles">
							</div>
						</div>
						<div class="col-sm-5">
						<div class="form-group">
								<label for="">Monto Dólares</label><input value="<?php echo $banco->monto_dolares; ?>" autocomplete="off" class="form-control" placeholder="Total dólares" type="text" name="monto_dolares" id="monto_dolares">
							</div>
						</div>	
						<div class="col-sm-2">
						<div class="form-group">
								<label for="">Tipo de cambio</label><input value="<?php echo $banco->cambio; ?>" autocomplete="off" class="form-control" placeholder="DNI" type="text" name="cambio" id="cambio">
							</div>
						</div>										
					</div>														
