	...
	<div class="row">
		<div class="col-lg-12">
			<div class="element-wrapper">
				...
				<form  id="edit_requerimiento" name="edit_requerimiento" accept-charset="utf-8" enctype="multipart/form-data" method="post">
				<input type="hidden" value="<?php echo $requerimiento->id_requerimiento; ?>" name="id_requerimiento">
					...
					<div class="row" id="detalle_egreso">
						<div class="col-sm-12">
							<table id="dataTable12" style="display: block;overflow-x: auto;" class="dataTable table table-bordered table table-hover table-reponsive" width="100px">
								...
								<tbody>
								<?php foreach($detalles_requerimiento as $detalle_requerimiento ) { ?>
									<tr id="filadatos" class="filadatos table">
									<td> <input type="hidden" name="id_detalle_requerimiento[]" value="<?php echo $detalle_requerimiento->id_detalle_requerimiento; ?>"><input name="fecha_inicio[]" type="date"  min="2019-10-25" value="<?php echo date('Y-m-d',strtotime($detalle_requerimiento->fecha_inicio)); ?>"></td>
									<td> <input name="fecha_fin[]" type="date"  min="2019-10-25" value="<?php echo date("Y-m-d",strtotime($detalle_requerimiento->fecha_fin)); ?>"></td>
									<td> <input name="dni[]" placeholder="dni" value="<?php echo $detalle_requerimiento->dni; ?>"></td>
									<td> <input name="datos[]" placeholder="Datos de trabajador" value="<?php echo $detalle_requerimiento->datos_trabajador; ?>"></td>
									<td> <input name="descripcion[]" placeholder="Descripcion" value="<?php echo $detalle_requerimiento->descripcion; ?>"></td>
									<td> <input id="dias" name="dias[]" value="<?php echo $detalle_requerimiento->cantidad; ?>" placeholder="Días"><p hidden="hidden"><?php echo $detalle_requerimiento->cantidad; ?></p></td>
									<td> <input id="precio" name="precio[]" value="<?php echo $detalle_requerimiento->precio; ?>" placeholder="Precio"><p hidden="hidden"><?php echo $detalle_requerimiento->precio; ?></p></td>
									<td> <p><?php echo $detalle_requerimiento->cantidad*$detalle_requerimiento->precio; ?></p></td>
...
$(document).ready(function() {
	$("form[name='edit_requerimiento']").submit(function(e) {
			var formData = new FormData($(this)[0]);
			$.ajax({
				
				url: "<?php echo base_url('requerimiento/requerimiento_edit'); ?>",
				type: "POST",
				data: formData,
				async: true,
				beforeSend: function(){
