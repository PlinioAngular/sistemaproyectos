				...
				<form id="add_tipo_actividad" name="add_tipo_actividad" accept-charset="utf-8" enctype="multipart/form-data" method="post">
					...
					<div class="row">
						...
						<div class="form-group">
								<label for="">Nombre de TipoActividad</label><input autocomplete="off" class="form-control form-control-sm" placeholder="Nombre:" type="text" name="tipo_actividad" id="tipo_actividad">
							</div>
						</div>					
					</div>													
