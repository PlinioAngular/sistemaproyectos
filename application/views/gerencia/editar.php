				...
				<form id="add_gerencia" name="add_gerencia" accept-charset="utf-8" enctype="multipart/form-data" method="post">
					...
					<div class="row">
						...
						<div class="form-group">
								<label for="">Nombre de Gerencia </label><input autocomplete="off" value="<?php echo $gerencia->gerencia; ?>" class="form-control form-control-sm" placeholder="gerencia" type="text" name="gerencia" id="gerencia">
							</div>
						</div>					
					</div>													
...
$(document).ready(function() {
		$("form[name='add_gerencia']").submit(function(e) {
			var formData = new FormData($(this)[0]);
			$.ajax({
				
				url: "<?php echo base_url('gerencia/gerencia_edit'); ?>",
				type: "POST",
				data: formData,
				async: true,
				beforeSend: function(){
				...
				var status=str[0];
					...
					if(status=="si")
					{
						...
						setTimeout(function () {
						window.location.href="<?php echo base_url('gerencia' ); ?>/";
