				...
				<form id="add_gerencia" name="add_gerencia" accept-charset="utf-8" enctype="multipart/form-data" method="post">
					...
					<div class="row">
						...
						<div class="form-group">
								<label for="">Nombre de gerencia</label><input autocomplete="off" class="form-control form-control-sm" placeholder="Nombre:" type="text" name="gerencia" id="gerencia">
							</div>
						</div>					
					</div>													
...
$(document).ready(function() {
		$("form[name='add_gerencia']").submit(function(e) {
			...
			$.ajax({
				...
				url: "<?php echo base_url('gerencia/gerencia_add'); ?>",
				type: "POST",
				data: formData,
				async: true,
				beforeSend: function(){
