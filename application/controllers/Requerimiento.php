...
class Requerimiento extends CI_Controller {
	...
	public function ajax(){
		$data= $this->requerimiento_model->mostrar();
		$pasar=array();
		$i=0;
		foreach($data as $requerimiento){
			...
			$pasar[$i][6]='<button aria-expanded="false" aria-haspopup="true" class="btn btn dropdown-toggle" data-toggle="dropdown" id="dropdownMenuButton1" type="button">Opción</button>
			<div aria-labelledby="dropdownMenuButton1" class="dropdown-menu">
			<a class="dropdown-item" href="'.base_url().'requerimiento/edit/'.md5($requerimiento->id_requerimiento).'" >Editar</a><a class="dropdown-item" href="#">Dar de Baja</a>
